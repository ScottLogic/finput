import { load, finputReversedDelimiters } from '../pageObjects/index';
import customCommandsFactory from '../customCommands';
const customCommands = customCommandsFactory(finputReversedDelimiters);
const typing = customCommands.typing;
const copyingAndPasting = customCommands.copyingAndPasting;
const cutting = customCommands.cutting;

describe('Custom options (reversed delimiters)', () => {
  beforeEach(async () => {
    await load();
  });
